...
test("mtx: mags", function ()
  ...
  local m = M:mags("row")
  assert(math.abs(m:get(0) - 5) < 1e-10)
  assert(math.abs(m:get(1) - 13) < 1e-10)
end)
...
test("mtx: center fit/apply", function ()
  ...
  assert(math.abs(means:get(0) - 2) < 1e-10)
  assert(math.abs(means:get(1) - 15) < 1e-10)
...
test("mtx: standardize fit returns means + inv_std", function ()
  ...
  assert(math.abs(sums:get(0)) < 1e-9)
  assert(math.abs(sums:get(1)) < 1e-9)
end)
...
test("mtx: normalize row", function ()
  ...
  local m = M:mags("row")
  assert(math.abs(m:get(0) - 1) < 1e-10)
  assert(math.abs(m:get(1) - 1) < 1e-10)
end)
